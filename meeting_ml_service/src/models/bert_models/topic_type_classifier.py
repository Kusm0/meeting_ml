"""
BERT-based Topic Type Classification model.
4-class classification using fine-tuned DistilBERT.
"""
...
class TopicTypeClassifierBERTModel(nn.Module):
    """BERT-based 4-class classifier."""
...
class TopicTypeClassifierBERT(BaseModel):
    """
    DistilBERT fine-tuned for Topic Type Classification.
    ...
    def __init__(
        ...
        """
        Initialize BERT Topic Type Classifier.
        """
    ...
    def _init_model(self) -> None:
        ...
        self.model = TopicTypeClassifierBERTModel(
    ...
    def train(
        ...
        """Train the model."""
        logger.info(
            f"Training Topic Type Classifier (BERT) on "
    ...
    def _save_checkpoint(self, epoch: int, history: Dict[str, Any]) -> None:
        ...
        checkpoint_dir = settings.base_dir / "checkpoints" / "bert" / "topic_type"
