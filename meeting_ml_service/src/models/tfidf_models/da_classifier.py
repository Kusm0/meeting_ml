"""
TF-IDF based Dialogue Act Classification model.
15-class classification for dominant dialogue act.
"""
...
class DAClassifierTFIDF(BaseModel):
    """
    TF-IDF + Logistic Regression for Dialogue Act Classification.
    ...
    def train(
        ...
        """
        logger.info(
            f"Training DA Classifier (TF-IDF) on "
    ...
    def predict_proba(self, X: Any) -> np.ndarray:
        ...
        Returns:
            Class probabilities for all 15 classes
        """
        if not self.is_trained:
            raise ValueError("Model not trained.")
